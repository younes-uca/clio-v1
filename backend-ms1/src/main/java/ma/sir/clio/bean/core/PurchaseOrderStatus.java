...
public class PurchaseOrderStatus   extends AuditBusinessObject     {
    ...
    public PurchaseOrderStatus(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        PurchaseOrderStatus purchaseOrderStatus = (PurchaseOrderStatus) o;
        return id != null && id.equals(purchaseOrderStatus.id);
    }
