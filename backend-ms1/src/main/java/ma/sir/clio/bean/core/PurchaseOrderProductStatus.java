...
public class PurchaseOrderProductStatus   extends AuditBusinessObject     {
    ...
    public PurchaseOrderProductStatus(){
        super();
    }

    public PurchaseOrderProductStatus(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        PurchaseOrderProductStatus purchaseOrderProductStatus = (PurchaseOrderProductStatus) o;
        return id != null && id.equals(purchaseOrderProductStatus.id);
    }
