...
public class OrderSupplierType   extends AuditBusinessObject     {
    ...
    public OrderSupplierType(){
        super();
    }

    public OrderSupplierType(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        OrderSupplierType orderSupplierType = (OrderSupplierType) o;
        return id != null && id.equals(orderSupplierType.id);
    }
