...
public class UnitePrice   extends AuditBusinessObject     {
    ...
    public UnitePrice(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        UnitePrice unitePrice = (UnitePrice) o;
        return id != null && id.equals(unitePrice.id);
    }
