...
public class OrderSupplierStatus   extends AuditBusinessObject     {
    ...
    public OrderSupplierStatus(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        OrderSupplierStatus orderSupplierStatus = (OrderSupplierStatus) o;
        return id != null && id.equals(orderSupplierStatus.id);
    }
