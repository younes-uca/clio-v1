package ma.sir.clio.zynerator.converter;


import ma.sir.clio.zynerator.bean.Etablissement;
import ma.sir.clio.zynerator.dto.EtablissementDto;

import ma.sir.clio.zynerator.util.ListUtil;
import ma.sir.clio.zynerator.audit.AuditBusinessObject;
import ma.sir.clio.zynerator.bean.BusinessObject;
import ma.sir.clio.zynerator.dto.AuditBaseDto;
import ma.sir.clio.zynerator.dto.BaseDto;
import ma.sir.clio.zynerator.util.DateUtil;
import ma.sir.clio.zynerator.util.RefelexivityUtil;
import ma.sir.clio.zynerator.util.StringUtil;
import ma.sir.clio.zynerator.util.Utils;
