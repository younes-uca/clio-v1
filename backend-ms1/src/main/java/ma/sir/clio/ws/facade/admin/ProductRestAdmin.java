...
import ma.sir.clio.ws.converter.ProductConverter;
...
public class ProductRestAdmin  extends AbstractController<Product, ProductDto, ProductHistory, ProductCriteria, ProductHistoryCriteria, ProductAdminService, ProductConverter> {
    ...
    @ApiOperation("find by productFamily id")
    @GetMapping("productFamily/id/{id}")
    public List<Product> findByProductFamilyId(@PathVariable Long id){
        return service.findByProductFamilyId(id);
    }
    @ApiOperation("delete by productFamily id")
    @DeleteMapping("productFamily/id/{id}")
    public int deleteByProductFamilyId(@PathVariable Long id){
        return service.deleteByProductFamilyId(id);
    }
