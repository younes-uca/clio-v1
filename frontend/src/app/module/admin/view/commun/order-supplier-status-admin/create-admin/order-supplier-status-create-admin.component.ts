...
@Component({
  selector: 'app-order-supplier-status-create-admin',
  templateUrl: './order-supplier-status-create-admin.component.html'
})
export class OrderSupplierStatusCreateAdminComponent extends AbstractCreateController<OrderSupplierStatusDto, OrderSupplierStatusCriteria, OrderSupplierStatusService>  implements OnInit {
