...
@Component({
  selector: 'app-order-supplier-delivery-status-edit-admin',
  templateUrl: './order-supplier-delivery-status-edit-admin.component.html'
})
export class OrderSupplierDeliveryStatusEditAdminComponent extends AbstractEditController<OrderSupplierDeliveryStatusDto, OrderSupplierDeliveryStatusCriteria, OrderSupplierDeliveryStatusService>   implements OnInit {
