...
@Component({
  selector: 'app-unite-price-create-admin',
  templateUrl: './unite-price-create-admin.component.html'
})
export class UnitePriceCreateAdminComponent extends AbstractCreateController<UnitePriceDto, UnitePriceCriteria, UnitePriceService>  implements OnInit {
