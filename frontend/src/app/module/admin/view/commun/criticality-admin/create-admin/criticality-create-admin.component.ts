...
@Component({
  selector: 'app-criticality-create-admin',
  templateUrl: './criticality-create-admin.component.html'
})
export class CriticalityCreateAdminComponent extends AbstractCreateController<CriticalityDto, CriticalityCriteria, CriticalityService>  implements OnInit {
