...
@Component({
  selector: 'app-recipient-edit-admin',
  templateUrl: './recipient-edit-admin.component.html'
})
export class RecipientEditAdminComponent extends AbstractEditController<RecipientDto, RecipientCriteria, RecipientService>   implements OnInit {
