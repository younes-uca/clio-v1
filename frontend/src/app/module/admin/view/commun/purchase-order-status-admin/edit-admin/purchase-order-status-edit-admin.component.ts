...
@Component({
  selector: 'app-purchase-order-status-edit-admin',
  templateUrl: './purchase-order-status-edit-admin.component.html'
})
export class PurchaseOrderStatusEditAdminComponent extends AbstractEditController<PurchaseOrderStatusDto, PurchaseOrderStatusCriteria, PurchaseOrderStatusService>   implements OnInit {
