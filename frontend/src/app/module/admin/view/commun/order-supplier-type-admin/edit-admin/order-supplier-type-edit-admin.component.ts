...
@Component({
  selector: 'app-order-supplier-type-edit-admin',
  templateUrl: './order-supplier-type-edit-admin.component.html'
})
export class OrderSupplierTypeEditAdminComponent extends AbstractEditController<OrderSupplierTypeDto, OrderSupplierTypeCriteria, OrderSupplierTypeService>   implements OnInit {
