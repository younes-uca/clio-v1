...
@Component({
  selector: 'app-purchase-order-product-status-create-admin',
  templateUrl: './purchase-order-product-status-create-admin.component.html'
})
export class PurchaseOrderProductStatusCreateAdminComponent extends AbstractCreateController<PurchaseOrderProductStatusDto, PurchaseOrderProductStatusCriteria, PurchaseOrderProductStatusService>  implements OnInit {
