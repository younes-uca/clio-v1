...
@Component({
  selector: 'app-store-product-create-admin',
  templateUrl: './store-product-create-admin.component.html'
})
export class StoreProductCreateAdminComponent extends AbstractCreateController<StoreProductDto, StoreProductCriteria, StoreProductService>  implements OnInit {
