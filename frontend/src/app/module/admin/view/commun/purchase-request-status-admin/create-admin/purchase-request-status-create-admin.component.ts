...
@Component({
  selector: 'app-purchase-request-status-create-admin',
  templateUrl: './purchase-request-status-create-admin.component.html'
})
export class PurchaseRequestStatusCreateAdminComponent extends AbstractCreateController<PurchaseRequestStatusDto, PurchaseRequestStatusCriteria, PurchaseRequestStatusService>  implements OnInit {
