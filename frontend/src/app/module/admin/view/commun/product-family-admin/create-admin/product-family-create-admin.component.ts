...
@Component({
  selector: 'app-product-family-create-admin',
  templateUrl: './product-family-create-admin.component.html'
})
export class ProductFamilyCreateAdminComponent extends AbstractCreateController<ProductFamilyDto, ProductFamilyCriteria, ProductFamilyService>  implements OnInit {
