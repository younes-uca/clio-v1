...
@Component({
  selector: 'app-currency-edit-admin',
  templateUrl: './currency-edit-admin.component.html'
})
export class CurrencyEditAdminComponent extends AbstractEditController<CurrencyDto, CurrencyCriteria, CurrencyService>   implements OnInit {
